...
precedence(::EXPR) = error("An EXPR doesn't have a precedence.")
...
# this was added in https://github.com/JuliaLang/julia/commit/d50eac6b9ef0c3d244efc86a4540e816daa1a546 and is therefore available in all supported Julia versions
is_suffix_char(c::Char) = ccall(:jl_op_suffix_char, Bool, (UInt32,), c)
